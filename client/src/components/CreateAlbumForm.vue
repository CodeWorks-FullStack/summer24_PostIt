  ...
  <form class="container-fluid" @submit.prevent="createAlbum()">
    ...
    <section class="row">
      <div class="mb-2 col-6">
        ...
        <input v-model="albumData.title" class="form-control" type="text" id="album-title" name="album-title"
          minlength="3" maxlength="25" required>
      </div>
      <div class="mb-2 col-6">
        <label for="album-cover-img">Cover Image</label>
        <input v-model="albumData.coverImg" class="form-control" type="url" id="album-cover-img" name="album-cover-img"
          required>
      </div>
      <div class="mb-2 col-12">
        <label for="album-description">Description</label>
        <textarea v-model="albumData.description" minlength="15" maxlength="250" class="form-control"
          name="album-description" id="album-description"></textarea>
      </div>
      <div class="mb-2 col-12">
